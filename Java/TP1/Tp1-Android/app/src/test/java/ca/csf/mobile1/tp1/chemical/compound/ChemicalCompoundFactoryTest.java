...
public class ChemicalCompoundFactoryTest {
    ...
    public void before() throws IOException {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("D:\\Cegep Ste-Foy\\Programmation Mobile I\\TP1\\Tp1-Console\\src\\test\\resources\\chemicalElementsForTests.txt")))
        {
            String line;
            ...
            while ((line = br.readLine()) != null)
            {
                ...
                chemicalElementRepository.add(new ChemicalElement(words[0],words[1],Integer.parseInt(words[2]), Double.parseDouble(words[3])));
            }
        }
        catch(Exception e)
        {
    ...
    public void canCreateChemicalCompoundFromStringWithParenthesis() throws Exception {
        ...
        //Here, if the weight is good, we assume that the compound is created correctly
        assertEquals(223.24303856D, chemicalCompoundFactory.createFromString("(NaCl)4").getWeight(), 0.01D);
