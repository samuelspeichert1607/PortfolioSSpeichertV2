...
import ca.csf.mobile1.tikiappbar.model.IngredientRepository;
...
public class SQLiteIngredientRepository implements IngredientRepository {
    ...
    /**
     * Requète préparée pour insérer un ingrédient spécifique.
     * @param ingredient l'ingrédient que l'on désire insérer.
     */
    @Override
