...
function suitesChart() {
	...
	var data = [
		{ value: passed, color: '#00af00', highlight: '#32bf32', label: 'Réussi' },
		{ value: failed, color:'#F7464A', highlight: '#FF5A5E', label: 'Échoué' },
		{ value: $('.suite-result.error').length, color:'#ff6347', highlight: '#ff826b', label: 'Erreur' },
		{ value: $('.suite-result.inconclusive').length, color: '#FDB45C', highlight: '#FFC870', label: 'Avertissement' },
		{ value: $('.suite-result.skipped').length, color: '#1e90ff', highlight: '#4aa6ff', label: 'Ignoré' }
	];
...
function testsChart() {
    ...
    if ($('body.summary').length > 0) {
        ...
        data = [
            { value: passed, color: '#00af00', highlight: '#32bf32', label: 'Réussi' },
            { value: failed, color:'#F7464A', highlight: '#FF5A5E', label: 'Échoué' },
            { value: others, color: '#1e90ff', highlight: '#4aa6ff', label: 'Autres' }
        ];
        ...
        data = [
            { value: passed, color: '#00af00', highlight: '#32bf32', label: 'Réussi' },
            { value: failed, color:'#F7464A', highlight: '#FF5A5E', label: 'Échoué' },
            { value: errors, color:'#ff6347', highlight: '#ff826b', label: 'Erreur' },
            { value: inconclusive, color: '#FDB45C', highlight: '#FFC870', label: 'Avertissement' },
            { value: skipped, color: '#1e90ff', highlight: '#4aa6ff', label: 'Ignoré' }
        ];
