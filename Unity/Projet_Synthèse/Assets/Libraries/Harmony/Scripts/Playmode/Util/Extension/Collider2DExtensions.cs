...
namespace Harmony
{
    ...
    public static class Collider2DExtensions
    {
        ...
        public class Collider2DEventsWrapper : Script
        {
            ...
            /// <summary>
            /// Évènement se déclanchant lorsqu'un autre trigger reste en collision avec celui-ci.
            /// </summary>
            public event Trigger2DEventHandler OnStayTrigger;
            ...
            {
                if (OnStayTrigger != null) OnStayTrigger(other);
            }
