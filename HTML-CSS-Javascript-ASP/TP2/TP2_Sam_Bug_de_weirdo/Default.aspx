    ...
    <div id="container">
        ...
        <!--<div id="contenu">-->
            ...
            <asp:Panel ID="PanelFormInscription" runat="server" Height="386px">
                ...
                <asp:RequiredFieldValidator ValidateEmptyText="false" EnableClientScript="false" ControlToValidate="TextBoxPrenom" ID="RequiredFieldValidator1"  runat="server" ErrorMessage="Veuillez écrire votre prénom..."></asp:RequiredFieldValidator>
                <br />
                <asp:Label ID="LabelNom" runat="server" Text="Nom :"></asp:Label>
                <asp:TextBox ID="TextBoxNom" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator ValidateEmptyText="false" EnableClientScript="false" ControlToValidate="TextBoxNom"  ID="RequiredFieldValidator2" runat="server" ErrorMessage="Veuillez écrire votre nom..."></asp:RequiredFieldValidator>
                <br />
                ...
                <asp:RequiredFieldValidator ValidateEmptyText="false" EnableClientScript="false" ControlToValidate="TextBoxMatricule" ID="RequiredFieldValidator3"  runat="server" ErrorMessage="Veuillez écrire votre matricule..."></asp:RequiredFieldValidator>
                
                <br />
                <asp:Button ID="ButtonSoumettre" runat="server" Text="Soumettre" OnClick="ButtonSoumettre_Click" />
